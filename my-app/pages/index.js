...
export default function Home() {
  ...
  */
  ...
  return (
    <div>
      <Head>
        <title>E-Mikko Lottery</title>
        <meta name="description" content="EMikko-Lottery-Dapp" />
      ...
      <div className={styles.main}>
        ...
        <div>
          <img className={styles.image} src="./banner.png" />
        </div>
      </div>

      <footer className={styles.footer}>Made with &#10084; by E-Mikko</footer>
    </div>
  );
}